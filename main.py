...
# from tkinter import filedialog, messagebox  # Added import for messagebox
#
# import pickle
...
#         if file_path:
#             self.recognize_faces(image_location=file_path)
#         else:
...
#             self, model: str = "hog", encodings_location: Path = None
#     ) -> None:
#         print("It is working")
#         """
...
from src.image_processing.face_detection_gui import main
